...
# format df to training data format
  cat("Condition",file="training_files/SW_48/Park/training_file.txt",sep="\n")
  cat("-",file="training_files/SW_48/Park/training_file.txt",sep="\n", append = TRUE)
  cat("Response",file="training_files/SW_48/Park/training_file.txt",sep="\n", append = TRUE)
  ...
  cat(node_value_string, file="training_files/SW_48/Park/training_file.txt", append=TRUE)
  cat("\t", file="training_files/SW_48/Park/training_file.txt", append=TRUE)
  }
  cat("\nWeight:1",file="training_files/SW_48/Park/training_file.txt",sep="\n", append = TRUE)