...
results_ulm <- run_ulm(mat= HCT_differential_analysis, network = dorothea_df, .source='tf', .target='target', .mor='mor', minsize = 5)
results_ulm
...
# format df to training data format
  ...
  cat(node_value_string, file="training_files/HCT-116/Park/training_fil.txt", append=TRUE)
