...
main_directory <- "HCT-116_Lu/Synergy_results/Bootstrap/HCT-116_Lu_42_nodes"
...
for (synergy_file in synergy_files) {
  ...
  observed_synergies_file <- file.path("HCT-116_Lu/observed_synergies_Lu_HCT_116")
...
write.table(auc_df, file = "Bulk_synergy_results/HCT-116_Lu_PROFILE_new.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
