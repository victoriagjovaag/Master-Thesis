...
main_directory <- "COLO_205_Lu/Synergy_results/Bootstrap/COLO_205_Lu_3_nodes"
...
for (synergy_file in synergy_files) {
  ...
  observed_synergies_file <- file.path("COLO_205_Lu/observed_synergies_Lu_COLO_205")
...
write.table(auc_df, file = "Bulk_synergy_results/COLO-205_Lu_PROFILE_new.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
