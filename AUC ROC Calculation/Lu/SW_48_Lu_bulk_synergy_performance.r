...
main_directory <- "SW_48_Lu/Synergy_results/Bootstrap/SW_48_Lu_37_nodes"
...
for (synergy_file in synergy_files) {
  ...
  observed_synergies_file <- file.path("SW_48_Lu/observed_synergies_Lu_SW_48")
...
write.table(auc_df, file = "Bulk_synergy_results/SW_48_Lu_PROFILE_new.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
