...
main_directory <- "SW_48_Park/Synergy_results/Bootstrap/SW_48_Park_16_nodes"
...
for (synergy_file in synergy_files) {
  ...
  observed_synergies_file <- file.path("SW_48_Park/observed_synergies_Park_SW_48")
...
write.table(auc_df, file = "Bulk_synergy_results/SW_48_Park_PROFILE.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
