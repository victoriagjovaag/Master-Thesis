...
main_directory <- "HCT-116_Park/Synergy_results/Bootstrap/HCT-116_Park_58_nodes"
...
for (synergy_file in synergy_files) {
  ...
  observed_synergies_file <- file.path("HCT-116_Park/observed_synergies_Park_HCT_116")
...
#write.table(auc_df, file = "Bulk_synergy_results/HCT-116_PROFILE_inverted.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
