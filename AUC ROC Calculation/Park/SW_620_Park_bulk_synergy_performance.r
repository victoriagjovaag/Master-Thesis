...
main_directory <- "SW_620_Park/Synergy_results/Bootstrap/SW_620_Park_11_nodes"
...
for (synergy_file in synergy_files) {
  ...
  observed_synergies_file <- file.path("SW_620_Park/observed_synergies_Park_SW_620")
...
#write.table(auc_df, file = "Bulk_synergy_results/SW_620_Park_PROFILE_new.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE)
